...
// ファイル名にドメイン名を追加
// Cookieバナー自動閉じ　無効化 cookieバナーもデザインの参考になる
...
//  Utility: 1ページを撮影
// ============================================================
async function capturePage(pageLink, browser, outputDir, vp, slug, domain) {
...
async function processSite(TARGET_URL, browser) {
  ...
  for (const link of uniqueLinks) {
    ...
    for (const vp of viewports) {
      await capturePage(link, browser, outputDir, vp, slug, domain);
    }
  }
}
